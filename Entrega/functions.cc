...
void DisplayObstacleMenu() {
  ...
  std::cout << "1: Añadir obstáculos uno a uno (Seleccionar 0 para generar un mapa limpio)" << std::endl;
  std::cout << "2: Introducir aleatoriamente" << std::endl;
  std::cout << "3: Leer obstaculos de un fichero" << std::endl;
  std::cout << "4: Introducir un porcentaje" << std::endl;
}
